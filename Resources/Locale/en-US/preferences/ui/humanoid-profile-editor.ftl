...
humanoid-profile-editor-preference-unavailable-stay-in-lobby-button = Залишатись у лобі, якщо немає бажаних ролей.
humanoid-profile-editor-preference-unavailable-spawn-as-overflow-button = Отримати роль {$overflowJob}, якщо неможливо отримати бажані.
