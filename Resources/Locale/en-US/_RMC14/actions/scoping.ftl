cm-action-popup-scoping-user = Ви підносите {THE($scope)} до очей.
cm-action-popup-scoping-stopping-user = Ви віддаляєте {THE($scope)} від очей.
...
cm-action-popup-scoping-user-must-wield = Ви повинні тримати {THE($scope)} двома руками щоб використовувати приціл.
cm-action-popup-scoping-must-attach = {CAPITALIZE(THE($scope))} має бути прикріплено до зброї щоб його використати!
