...
rmc-toggleable-ammo-highly-precise = надточними
...
rmc-toggleable-motion-detector-on = Ви увімкнули детектор руху {THE($gun)}.
rmc-toggleable-motion-detector-off = Ви вимкнули детектор руху {THE($gun)}.
