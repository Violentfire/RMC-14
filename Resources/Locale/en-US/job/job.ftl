...
job-greet-important-disconnect-admin-notify = Ви граєте на посаді, важливій для прогресу раунда. Якщо потрібно відключитися, повідомте адміністтрацію через ahelp.
...
job-greet-crew-shortages = Оскільки станція спочатку була укомплектована мінімальним екіпажем, до вашої ID-карти додано додатковий доступ.
