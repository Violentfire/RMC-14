...
ui-vote-type-gamemode = Наступний режим
ui-vote-type-map = Наступна мапа
ui-vote-type-votekick = Голосування за вигнання

# Votekick reasons
ui-vote-votekick-type-raiding = Набіг
ui-vote-votekick-type-cheating = Чітерство
ui-vote-votekick-type-spamming = Спамерство
